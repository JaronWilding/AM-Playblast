# Setup a default Maya version if not specified
...
find_path(MAYA_LIBRARY_DIR ${OPENMAYA} PATHS ${MAYA_LOCATION} $ENV{MAYA_LOCATION} PATH_SUFFIXES ${MAYA_LIB_SUFFIX} DOC "Maya library path")
find_path(MAYA_INCLUDE_DIR "maya/MFn.h" PATHS ${MAYA_LOCATION} $ENV{MAYA_LOCATION} PATH_SUFFIXES ${MAYA_INC_SUFFIX} DOC "Maya include path")
